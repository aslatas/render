...
void test_add_one_mesh()
{
    ...
    assert(100 == mfr->attribs[0].vertex_count);
    assert(100 == mfr->attribs[0].index_count);
    assert(100 == mfr->attribs[0].uniform_index);
...
void test_add_many_meshes()
{
    ...
    assert(200 == mfr->attribs[0].vertex_count);
    assert(200 == mfr->attribs[0].index_count);
    assert(200 == mfr->attribs[0].uniform_index);
    // get mesh by filename
    ...
    assert(300 == mfr->attribs[0].vertex_count);
    assert(300 == mfr->attribs[0].index_count);
    assert(300 == mfr->attribs[0].uniform_index);
    // get mesh by filename
...
{
    Scene scene(102835, "no_file");
    scene.LoadMeshFromFile(Scene::GLTF, "../../../resources/models/Box/glTF-Binary/Box.glb");
