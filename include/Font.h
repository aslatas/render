...
BitmapFont LoadBitmapFont(const VulkanInfo *vulkan_info, const char *path, uint32_t shader_id, uint32_t first_character = 32, uint32_t character_count = 96,  uint32_t resolution = 512, float character_size = 64.0f, bool generate_mips = true);
